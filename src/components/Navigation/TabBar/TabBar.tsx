...
// import { selectChainId } from '@/src/selectors/networkController';
...
import { colors as importedColors } from '@/src/styles/common';
...
const TabBar = ({ state, descriptors, navigation }: TabBarProps) => {
  ...
  const renderTabBarItem = useCallback(
    (route: { name: string; key: string }, index: number) => {
      ...
      const tabBarIconKey = options.tabBarIconKey as keyof typeof ICON_BY_TAB_BAR_ICON_KEY;
