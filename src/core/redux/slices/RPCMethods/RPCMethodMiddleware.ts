...
import { RPC } from '@/src/constants/network';
import { ChainId, NetworkType } from '@metamask/controller-utils';
import {
  PermissionController,
  permissionRpcMethods,
} from '@metamask/permission-controller';
import { blockTagParamIndex, getAllNetworks } from '../../../../util/networks/index.js';
import { polyfillGasPrice } from './utils';
import {
  processOriginThrottlingRejection,
  validateOriginThrottling,
} from './spam';
import ImportedEngine from '../../../Engine/index.js';
import { strings } from '@/src/locales/i18n';
import { resemblesAddress, safeToChecksumAddress } from '@/src/util/address';
import { store } from '../../../../store/index.js';
import { removeBookmark } from '@/src/actions/bookmarks';
import setOnboardingWizardStep from '../../actions/wizard';
import { v1 as random } from 'uuid';
import { getPermittedAccounts } from '../../../Permissions/index.js';
import AppConstants from '../../../AppConstants.js';
import PPOMUtil from '../../../../lib/ppom/ppom-util.js';
import { selectProviderConfig } from '../../../../selectors/networkController.js';
